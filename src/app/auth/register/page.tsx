            ...
            <Card className="w-full max-w-lg relative z-10 shadow-2xl border-[#333333] bg-[#262626] text-white overflow-hidden rounded-2xl">
                ...
                <CardContent className="space-y-4 px-8 pb-6">
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="password" university-id="password-label" className="text-slate-300 font-medium ml-1">Password</Label>
                                <Input
                                    id="password"
                                    type="password"
                                    value={password}
                                    ...
                                    required
                                    minLength={6}
                                    className="bg-slate-900/50 border-slate-700 text-white h-10 rounded-xl focus:ring-primary/20 focus:border-primary transition-all"
                                />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="confirmPassword" university-id="confirm-password-label" className="text-slate-300 font-medium ml-1">Confirm Password</Label>
                                <Input
                                    id="confirmPassword"
                                    type="password"
